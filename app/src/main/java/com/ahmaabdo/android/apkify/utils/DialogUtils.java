...
public class DialogUtils {
    ...
    public static MaterialDialog showTitleContent(
    ...
    public static MaterialDialog showTitleContentWithProgress(
            Context context, String title, String content) {
        MaterialDialog.Builder materialBuilder = new MaterialDialog.Builder(context)
                .title(title)
                .content(content)
    ...
    public static SnackBar showSnackBar(
            Activity activity, String text, @Nullable String buttonText,
            @Nullable final File file, int style) {
