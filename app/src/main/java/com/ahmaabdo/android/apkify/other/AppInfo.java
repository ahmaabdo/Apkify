...
public class AppInfo implements Serializable {
    ...
    public AppInfo(String name, String apk, String version, String source,
                   String data, Boolean system, Boolean favorite,
                   Boolean hidden, Boolean disabled, Drawable icon) {
        this.name = name;
        this.apk = apk;
